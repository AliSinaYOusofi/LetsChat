...
export default function Navbar() {
  return (
    ...
    <nav className="bg-gray-200 border-gray-200 px-2 sm:px-4 py-2.5 rounded ">
        ...
        <a href="https://flowbite.com/" className="flex items-center ml-20">
            <img src="https://flowbite.com/docs/images/logo.svg" className="h-6 mr-3 sm:h-9" alt="Flowbite Logo" />
            <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">LetsChat</span>
        </a>
            <div className="flex items-center md:order-2 mr-20">
